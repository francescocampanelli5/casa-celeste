    ...
    privacy: {
      ...
      paragraphs: {
        it: [
          ...
          'Firma elettronica del contratto (se attiva): se il titolare ha attivato la firma OTP del contratto di locazione, riceverai via email un codice numerico da inserire sul sito. Per garantire la validità della firma elettronica semplice (art. 20 D.Lgs. 82/2005), al momento della firma registriamo anche l\'indirizzo IP, la data e ora esatte e il tipo di browser/dispositivo utilizzato, oltre all\'indirizzo email a cui è stato inviato il codice: questi dati costituiscono la prova della firma e sono conservati per lo stesso periodo dei dati della prenotazione.',
        ...
        en: [
          ...
          'Electronic signature of the contract (if enabled): if the owner has enabled OTP signing of the rental agreement, you\'ll receive a numeric code by email to enter on the site. To ensure the validity of this simple electronic signature (Art. 20, Italian Legislative Decree 82/2005), at the moment of signing we also record your IP address, the exact date and time, and your browser/device type, together with the email address the code was sent to: this data serves as proof of the signature and is kept for the same period as the booking data.',
