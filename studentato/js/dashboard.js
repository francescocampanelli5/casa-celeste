(function () {
  ...
  function renderLogin() {
    ...
    if (state.mfaResolver) {
      ...
      document.getElementById('mfa-form').addEventListener('submit', function (e) {
        ...
        window.CasaCelesteDB.completeMfaSignIn(state.mfaResolver, factorUid, code).catch(function () {
    ...
    document.getElementById('login-form').addEventListener('submit', function (e) {
      ...
      window.CasaCelesteDB.signIn(email, password).catch(function (err) {
        ...
        if (window.CasaCelesteDB.isMfaRequiredError(err)) {
          state.mfaResolver = window.CasaCelesteDB.getMfaResolver(err);
          renderLogin();
          return;
        }
  ...
  /* ==========================================================================
     ...
     Impostazioni. Stesso account Firebase Auth condiviso con l'affittacamere:
  ...
  function mfaSecurityCardHtml() {
    var factors = (window.CasaCelesteDB.mfaEnrolledFactors || function () { return []; })();
  ...
  function bindMfaSecurityEvents(content) {
    ...
    if (startBtn) startBtn.addEventListener('click', function () {
      ...
      window.CasaCelesteDB.startTotpEnrollment().then(function (secret) {
    ...
    if (confirmBtn) confirmBtn.addEventListener('click', function () {
      ...
      window.CasaCelesteDB.finishTotpEnrollment(state.mfaEnrollSecret, code, 'App autenticatore').then(function () {
    ...
    content.querySelectorAll('[data-mfa-unenroll]').forEach(function (el) {
      el.addEventListener('click', function () {
        ...
        window.CasaCelesteDB.unenrollMfaFactor(el.getAttribute('data-mfa-unenroll')).then(function () {
          renderSettingsTab(content);
        }).catch(function (err) {
